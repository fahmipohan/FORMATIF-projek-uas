...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3><i class="fas fa-edit"></i> Edit Proker Perhub</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="index.php?include=bpi">Perhub</a></li>
                    <li class="breadcrumb-item active">Edit Proker Perhub</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title" style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Edit Proker Perhub</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        </br>
        ...
        <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-edit-proker-perhub">
            <div class="card-body">
