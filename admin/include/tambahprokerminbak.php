...
<section class="content-header" >
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3><i class="fas fa-plus"></i> Tambah Program Kerja Minbak</h3>
            </div>
            <div class="col-sm-6">
...
<section class="content" >
    ...
    <div class="card card-info">
        ...
        <form class="form-horizontal" action="index.php?include=konfirmasi-tambah-proker-minbak" method="post">
            <div class="card-body">
