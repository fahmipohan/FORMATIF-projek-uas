...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3><i class="fas fa-edit"></i> Edit Proker BPI</h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="index.php?include=bpi">BPI</a></li>
                    <li class="breadcrumb-item active">Edit Proker BPI</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="card card-info">
        ...
        <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-edit-proker-bpi">
            <div class="card-body">
