...
?>
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-edit"></i> Edit Proker PSDM</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php?include=psdm">PSDM</a></li>
              <li class="breadcrumb-item active">Edit Proker PSDM</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title" style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Edit Proker BPI</h3>
            <div class="card-tools">
                <a href="index.php?include=bpi" class="btn btn-sm btn-warning float-right"><i
        ...
        <div class="alert alert-danger" role="alert">Maaf deskripsi tidak boleh kosong</div>
        <?php } ?>
        <?php } ?>

        <?php if (!empty($_GET['notif'])) { ?>
        <?php if ($_GET['notif'] == "departemenkosong") { ?>
        <div class="alert alert-danger" role="alert">Maaf departemen tidak boleh kosong</div>
        <?php } ?>
        <?php } ?>

        <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-edit-proker-psdm">
            <div class="card-body">
