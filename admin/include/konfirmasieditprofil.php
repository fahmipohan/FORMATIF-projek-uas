...
if(isset($_SESSION['id_user'])){
	...
	if(empty($nama)){
	header("Location:index.php?include=edit-profil&data=".$id_user."&notif=editnamakosong");
	}else if(empty($email)){
	header("Location:index.php?include=edit-profil&data=".$id_user."&notif=editemailkosong");
	}else if(empty($user)){
	header("Location:index.php?include=edit-profil&data=".$id_user."&notif=edituserkosong");
	}else{
