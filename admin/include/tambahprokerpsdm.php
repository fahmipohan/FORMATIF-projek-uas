...
<section class="content-header" >
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3><i class="fas fa-plus"></i> Tambah Program Kerja PSDM</h3>
            </div>
            <div class="col-sm-6">
...
<section class="content" >
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title" style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Tambah Program Kerja PSDM</h3>
        ...
        <div class="col-sm-10">
            <?php if (!empty($_GET['notif'])) { ?>
            <?php if ($_GET['notif'] == "deskripsikosong") { ?>
            <div class="alert alert-danger" role="alert">
                Maaf deskripsi proker tidak boleh kosong</div>
            <?php } ?>
            <?php } ?>
        </div>
        <form class="form-horizontal" action="index.php?include=konfirmasi-tambah-proker-psdm " method="post">
            <div class="card-body">
