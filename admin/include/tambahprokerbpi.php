...
<section class="content-header" >
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3><i class="fas fa-plus"></i> Tambah Program Kerja BPI</h3>
            </div>
            <div class="col-sm-6">
...
<section class="content" >
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title" style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Tambah Program Kerja BPI
            </h3>
        ...
        <form class="form-horizontal" action="index.php?include=konfirmasi-tambah-proker-bpi" method="post">
            <div class="card-body">
