    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-plus"></i> Tambah Anggota KOMINFO</h3>
          </div>
          <div class="col-sm-6">
    ...
    <div class="card card-info">
      ...
      <?php }?>
      <?php }?>
      <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-tambah-anggota-kominfo" enctype="multipart/form-data">
        <div class="card-body">
